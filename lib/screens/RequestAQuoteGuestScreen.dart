...
class RequestAQuoteGuestScreen extends StatefulWidget {
  static const routeName = "/request-a-quote-guest";

  @override
  _RequestAQuoteGuestScreenState createState() => _RequestAQuoteGuestScreenState();
}

class _RequestAQuoteGuestScreenState extends State<RequestAQuoteGuestScreen> {
...
final GlobalKey<FormState> _formKey = GlobalKey();
  ...
  _sendRequestQuote() async{
    ...
    bool sendData = await Provider.of<RequestQuoteProvider>(context, listen: false)
        .sendData(_name.text, _email.text, _selectedCountry, _boxWeight.text,_selectedWeight, _boxQty.text, _itemDescription.text, _length.text, _width.text, _height.text, _selectedLength, _contactNumber.text, _message.text, token);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          PageTitleWidget('Request A Quote - Guest'),
          Container(
